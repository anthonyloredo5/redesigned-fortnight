...
import Rose from "../../assets/img/carousal/Rose.jpeg";
          ...
          <Row className="pt-3 pb-5 align-items-center">
            <Col xs={12} md={6}>
              <Row className="justify-content-center mb-2 mr-2 ">
                <Image className="profile justify-content-end" alt="profile" src={Rose} thumbnail fluid />
              </Row>
            </Col>
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    <a href="https://drive.google.com/file/d/1eU8iAGAQExNG9RUz-Snl4v3tXWrlE9Jm/view?usp=sharing" target="_blank" rel="noopener noreferrer">
